...
class BinanceRest {
    ...
    _makeRequest(query, callback, route, security, method, attempt = 0) {
        ...
        const type = _.last(route.split('/')),
            options = {
                url: `${route.substring(0,4) === 'api' ? 'https://api.binance.com/' : 'https://api.binance.com/'}${route}`,
    ...
    startUserDataStreamFutures(callback) {
        return this._makeRequest({}, callback, 'api/v1/listenKey', 'API-KEY', 'POST');
    }

    keepAliveUserDataStreamFutures(query = {}, callback) {
        return this._makeRequest(query, callback, 'api/v1/listenKey', 'API-KEY', 'PUT');
    }

    balanceFutures(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'api/v1/balance', 'SIGNED');
    }
    
    balanceFuturesv2(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'api/v2/balance', 'SIGNED');
    }
    
    positionRisk(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'api/v2/positionRisk', 'SIGNED');
    }
    
    newOrderFutures(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'api/v1/order', 'SIGNED', 'POST');
    }
    
    cancelOrderFutures(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'api/v1/order', 'SIGNED', 'DELETE');
    }
    
    cancelMultipleFutures(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'api/v1/batchOrders', 'SIGNED', 'DELETE');
    }
    
    queryOrderFutures(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'api/v1/order', 'SIGNED');
    }
    ...
    leverageFutures(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'api/v1/leverage', 'SIGNED', 'POST');
    }

    marginTypeFutures(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'api/v1/marginType', 'SIGNED', 'POST');
    }
    
    accountFutures(query = {}, callback) {
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'api/v2/account', 'SIGNED');
    }

    getIncomeFutures(query = {}, callback){
        this._setTimestamp(query);
        return this._makeRequest(query, callback, 'api/v1/income', 'SIGNED');
    }
}
